...
#ifndef MCENGINE_BLOCKGRAPHICSFAKER_HPP
#define MCENGINE_BLOCKGRAPHICSFAKER_HPP
#define BlockShape int

#include <vector>
#include "BlockFaker.hpp"
#include "../tools/lib_json/json/value.h"
...
#endif //MCENGINE_BLOCKGRAPHICSFAKER_HPP
