...
extern const char *(*fake_Item_getCommandName)(Item *);

extern void (*fake_Item_setCategory)(Item *, CreativeItemCategory);

//hook区
extern void (*base_Item_setIcon)(void *, std::string const &, short);

extern void NC_Item_setIcon(void *ptr, std::string const &str, short data);

extern void *(*base_Item_addCreativeItem)(Item *, short);

extern void *NC_Item_addCreativeItem(Item *obj, short a);

extern void (*base_Item_useOn)(void *, ItemStack &, Actor &, int, int, int, unsigned char, float, float, float);

extern void NC_Item_useOn(void *ptr, ItemStack &itemstack, Actor &actor, int x, int y, int z, unsigned char d, float e, float f, float g);
