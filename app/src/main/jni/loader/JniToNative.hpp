...
//                          lua_close(L);
    ...
    JNIEXPORT void JNICALL Java_com_taolesi_mcengine_NativeItem_createItem(JNIEnv *env, [[maybe_unused]] jclass clazz, jstring jname, jstring jiconName, jint jindex, jboolean is2category, jint jtype) {
